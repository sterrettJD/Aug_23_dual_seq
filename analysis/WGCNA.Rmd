...
SCNIC_analysis.py modules -i SCNIC_within_output/correls.txt -o SCNIC_modules_output/ --min_r .35 --table gf.ko.notax.subset.rel.f.biom
```
...
homicorr.res.w.w[homicorr.res.w.w$q < 0.05,]
