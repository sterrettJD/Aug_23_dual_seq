...
At the gut metabolic module level, transcripts for butyrate production are detectable. However, these two pathways are identical (the overlapping KO is K00248, 	
butyryl-CoA dehydrogenase, which takes us farther from butyrate...)
```{r}
...
# T cells
Differential expression analysis on the following GO terms only:
...
go_targeted_diffex <- function(go.term, host.genes, microbial.genes, microbial.gene){
